...
##’ This function generates sequences along the spectra (rows) or wavelengths
##’ of hyperSpec objects.
##’ 
##’ Note that \code{\link{wl2i}} generates sequences of indices along the
##’ wavelength axis.
##’ 
##’ \code{seq} had to be implemented as S3 method as the generic has only
##’ \dots{} arguments (on which no dispatch with differing types is possible).
##’ 
##’ \code{\link[base]{seq_along}} is not generic, but returns a sequence of the
##’ \code{length} of the object. As hyperSpec provides a Method
##’ \code{\link{length}}, it can be used. The result is a sequence of indices
##’ for the spectra.
##’ 
...
##’ @param \dots arguments for \code{\link[base]{seq}}, namely \code{by},
##’   \code{length.out}
