...
##’ 
##’ Blending two spectra can be a complicated procedure.
##’ 
...
##’ @param short handed to \code{\link{logentry}}
##’ @param user handed to \code{\link{logentry}}
##’ @param date handed to \code{\link{logentry}}
##’ @author C. Beleites
##’ @seealso \code{\link[base]{merge}} \code{\link{collapse}},
##’   \code{\link{rbind}}, and \code{\link{cbind}} for other ways of combining
##’   hyperSpec objects.
##’ @keywords manip
##’ @examples
##’ 
