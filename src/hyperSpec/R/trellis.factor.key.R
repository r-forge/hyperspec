...
##’ \code{\link[lattice]{levelplot}}, etc.) according to the factor levels. The
##’ colorkey will shows all levels (including unused), and the drawing colors
##’ will be set accordingly.
##’ 
##’ \code{trellis.factor.key} is used during \code{levelplot}-based plotting of
##’ factors (for hyperSpec objects) unless \code{transform.factor = FALSE} is
##’ specified.
##’ 
