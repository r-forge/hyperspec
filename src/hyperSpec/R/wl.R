...
##’ @return for \code{wl} a numeric vector, for \code{wl<-} a \code{hyperSpec}
##’   object.
...
##’   spectral range, use \code{\link[hyperSpec:extract_replace]{[}}, for
...
##’ 
##’ cutting the spectral range: \code{\link[hyperSpec:extract_replace]{[}}
##’ 
