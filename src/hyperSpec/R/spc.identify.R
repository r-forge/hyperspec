...
##’ 
##’ \code{spc.identify} uses option \code{debuglevel} to determine whether
##’ debugging output should be produced. \code{debuglevel == 2} will plot the
##’ tolerance window for every clicked point, \code{debuglevel == 1} will plot
##’ the tolerance window only if no data point was inside.  See
##’ \code{\link{hyperSpec options}} for details about retrieving and setting
##’ options.
##’ 
