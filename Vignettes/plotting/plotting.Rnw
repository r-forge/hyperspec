...
@
\\
\textbf{Intensities over concentration I}&\tabularnewline \nopagebreak
...
@
\\
\textbf{Intensities over concentration II}&\tabularnewline \nopagebreak
...
@
After zooming and rotating, the figure can be saved:
<<eval = FALSE>>=
