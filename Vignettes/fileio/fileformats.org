...
| ASCII  | ASCII wide  | Horiba Jobin Yvon |                  | read.txt.wide        | read.txt.Horiba      |                                                         |
...
| ASCII  | JCAMP-DX    |                   |                  | -                    | jcamp-dx             | see \Rfunction{read.jdx.Shimadzu}                       |
| ASCII  | JCAMP-DX    | Renishaw          | Raman            | -                    | jcamp-dx             | not available                                           |
| ASCII  | JCAMP-DX    | Shimadzu          | GC,GC-MS         | jcamp-dx             | read.jdx.Shimadzu    | import for very limited subset of the JCAMP-DX standard |
| ACII   | Witec ASCII | Witec             | Raman            | scan.txt.Witec       | scan.txt.Witec       |                                                         |
