...
scan.dat.Witec (filex = "txt.Witec/Witec-Map-x.dat", points.per.line = 5, lines.per.image = 5, type = "map")
@
...
cat ("with exported labels and units headerlines:")
t (simplify2array (strsplit (readLines ("txt.Witec/Witec-timeseries_full.txt"), "\t")))[1:4,1:3]

cat ("with exported labels headerline:")
t (simplify2array (strsplit (readLines ("txt.Witec/Witec-timeseries_label.txt"), "\t")))[1:4,1:3]

cat ("with exported units headerline:")
t (simplify2array (strsplit (readLines ("txt.Witec/Witec-timeseries_unit.txt"), "\t")))[1:4,1:4]

cat ("without headerline:")
t (simplify2array (strsplit (readLines ("txt.Witec/Witec-timeseries_no.txt"), "\t")))[1:4,1:4]
