...
plot (chondro [1,,1700 ~ max], plot.dots = list (ylim = c (-50, 200)))
cl <- "black"
pch = 1
bl <- spc.fit.poly.below (chondro [1,,1700 ~ max], poly.order = 1)
pch = 20
plot (chondro [1,,1715 ~ max], col = "blue", add = TRUE, lines.dots = list (lwd = 2))
cl <- "blue"
...
noise <- 12
plot (chondro [1,,1730 ~ max], plot.dots = list(ylim = c(-15, 20)))
