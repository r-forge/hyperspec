...
\begin{figure}[b]
\begin{center}
\includegraphics[width = .5\textwidth]{fig/fig-figspcrange}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width = .75\textwidth]{fig/fig-figorder}
...
\begin{figure}[bh]
\begin{center}
  \includegraphics[width=.75\textwidth]{fig/fig-fig1}
  \includegraphics[width=.75\textwidth]{fig/fig-fig2}
...
\begin{figure}[t]
\begin{center}
  \includegraphics[width=.5\textwidth]{fig/fig-fig3}
  \includegraphics[width=.75\textwidth]{fig/fig-fig4}
  \includegraphics[width=.75\textwidth]{fig/fig-fig5}
