...
print (levelplot (spc ~ .wavelength * t, laser,
                  contour = TRUE, labels = TRUE, col = "#00000080"))
@
<<plotmat2, fig = TRUE, include = FALSE>>=
plot (plot (flu, "mat")) 
@
\begin{figure}
\subfloat[\label{fig-plotmat-a}\Rcode{levelplot (spc ~ .wavelength * t, laser, contour = TRUE, labels = TRUE, col = "\#00000080")}]{\includegraphics[width=0.495\textwidth]{fig/fig-plotmat1}}%
\subfloat[\label{fig-plotmat-b}\Rcode{plot (plot (flu, "mat"))}]{\includegraphics[width=0.495\textwidth]{fig/fig-plotmat2}}%
