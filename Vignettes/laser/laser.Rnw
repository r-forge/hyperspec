...
\texttt{\small\textsl{> system.file ("doc/src/rawdata/laser.txt", package = "hyperSpec")}}.
...
@ 
After nicely rotating and zooming, the parameters to reconstruct this view can be re-applied:
<<>>=
par3d(userMatrix = matrix (c (-0.52,  0.4, -0.75, 0, 
                                 -0.85, -0.28, 0.44, 0, 
                                 -0.04,  0.87, 0.49, 0, 
                                 -0.80,  0.75,     0, 1), ncol = 4L),
         scale = c (2.75, 5, 0.175),
         windowRect = c(20L, 50L, 400L, 270L),
         zoom = 0.75)
@
...
\begin{figure}[t]
  \centering
  \includegraphics[width = .5\textwidth]{fig/fig-3D}  
