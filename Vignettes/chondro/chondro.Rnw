\documentclass[english,a4paper, 10pt, headings=small, DIV11]{scrartcl} % ursprünglich DIV 15
...
%
\begin{figure}[tbh]
\subfloat[\label{fig:bl-bl} The spectra after smoothing, baseline correction, and normalization.]{\includegraphics[width=0.4\textwidth]{chondro-norm}}\quad
\subfloat[\label{fig:bl:perc} The spectra after subtracting the 5\textsuperscript{th} percentile spectrum.]{\includegraphics[width=0.4\textwidth]{chondro-perc}}
...
png ("chondro-pca-pairs2.png", width = 1000, height = 1000)
...
{\includegraphics[width=0.495\textwidth]{chondro-clustmeans}}
\subfloat[\label{fig:DNA} False colour map of the DNA band intensities.]
{\includegraphics[width=0.495\textwidth]{chondro-DNA}}
