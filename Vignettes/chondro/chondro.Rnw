...
\begin{figure}[tbh]
\subfloat[\label{fig:irregular:a}Raster plot with two off-grid points.]{\includegraphics[width=0.3\textwidth]{chondro-fig--irregular-grid}}
\subfloat[\label{fig:irregular:b}[Coordinates are slightly wrong only.]{\includegraphics[width=0.3\textwidth]{chondro-fig--irregular-pts}}
\subfloat[\label{fig:irregular:c}[Raster plot of corrected grid.]{\includegraphics[width=0.3\textwidth]{chondro-fig--irregular-corr}}
...
%
\begin{figure}[tbh]
\subfloat[\Rfunction{pairs} plot of the first 7 scores.]{\includegraphics[width=0.495\textwidth]{chondro-fig--pca-pairs2}}%
\subfloat[The suspected outlier spectra.]{\includegraphics[width=0.495\textwidth]{chondro-fig--pca-outspc}}
