...
@ 
<<filenamecheck, echo = FALSE, results = hide>>= this is to ensure the building of the vignette on r-forge
#if (grepl ("inst/doc$", getwd()))
#   filename <- ("../../../Vignettes/chondro/chondro.txt")
@ 
<<import>>=
