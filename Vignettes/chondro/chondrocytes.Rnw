\documentclass[english,paper=a4, 10pt, headings=small, DIV11]{scrartcl} % ursprünglich DIV 15
...
\usepackage[unicode = true,
            ...
            linkcolor=blue!50          % color of internal links
           ]{hyperref}
...
\usepackage{fancyvrb}
%\usepackage{siunitx}
%\usepackage{relsize} %wird es benötigt?
...
frame indicates the measurement area (35~×~21 μm).}
\end{figure}
...
\item[Objective:] 100×, NA 0.85
\item[Measurement grid:] 35 ×~21 μm, 1 μm step size
...
spectra.]
{\includegraphics[width=0.5\textwidth]{chondrocytes-fig-rawspc}}
\subfloat[The sum intensity of the raw spectra.]
{\includegraphics[width=0.5\textwidth]{chondrocytes-fig-rawmap}}
...
\begin{figure}[tbh]
\subfloat[\label{fig:bl-bl} The spectra after smoothing, baseline correction, and normalization.]{\includegraphics[width=0.4\textwidth]{chondrocytes-norm}}\quad
\subfloat[\label{fig:bl:perc} The spectra after subtracting the 5\textsuperscript{th} percentile spectrum.]{\includegraphics[width=0.4\textwidth]{chondrocytes-perc}}
...
png ("chondrocytes-pca-pairs2.png", width = 1000, height = 1000)
...
%
\begin{figure}[tbh]
\subfloat[\Rfunction{pairs} plot of the first 7 scores.]{\includegraphics[width=0.495\textwidth]{chondrocytes-pca-pairs2}

}\subfloat[The suspected outlier spectra.]{\includegraphics[width=0.495\textwidth]{chondrocytes-pca-outspc}}\caption{Outlier removal by PCA}
...
<<dend, fig = TRUE, width = 7.5, height = 5, include = FALSE>>=         lkjfldsflsf sklföldsjflas
...
%
\begin{figure}[tbh]
\subfloat[\label{fig:dend} The dendrogram.]{\includegraphics[width=0.495\textwidth]{chondrocytes-dend}}\subfloat[\label{fig:clustmap} The cluster map for $k=3$ clusters.]{\includegraphics[width=0.495\textwidth]{chondrocytes-clustmap}}\caption{Hierarchical cluster analysis.}

\end{figure}



\section{Plotting a False-Color Map of Certain Spectral Regions}   
...
<<DNA, fig = TRUE, width = 7.5, height = 5, include = FALSE>>= klkasöl 
...
{\includegraphics[width=0.495\textwidth]{chondrocytes-clustmeans}}
\subfloat[\label{fig:DNA} False color map of the DNA band intensities.]
{\includegraphics[width=0.495\textwidth]{chondrocytes-DNA}}
\caption{}
\end{figure}
