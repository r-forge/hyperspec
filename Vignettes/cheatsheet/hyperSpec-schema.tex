...
\node [concept, color=root, text = blacktext,font=\huge\tt] (root) {\texttt{hyperSpec}}
     child[concept color=gruen, text = gruentext, grow = 35] {
        node[concept, text width=2.65cm] (plot) {Visualization: plots}%
           child [grow = 0, level distance=4cm]{node [concept, text width = 3cm] (plotc) {
               Time Series, \\Calibration,  \\Depth Profile}}
           child [grow = 310] {node [concept] (plotspc) {Spectra}}
           child [grow = 160] {node [concept] (plotmat) {Spectra\\Matrix}}
           child [grow = 45] {node [concept] (plotmap) {Images\\Maps}}
           child [grow = 85, concept color = blassgruen, text  = blassgruentext] {
     ...
     child[concept color=blau, text = blautext, grow = 145] {
       ...
       child[concept color=rot, text = rottext, level distance=8.5cm, grow=90] {
         ...
         child [grow = 210] {node [concept] {PLS}}
         child [grow =  90] {node [concept] {LDA}}
         child [grow =  30] {node [concept] {PCA}}
         child [grow = -30] {node [concept] {etc.}}
       }
...
\node [annotation, right, text ragged right, text width=5mm]  at (plotspc.east) {plotspc\\spc.identify\\stacked.offsets};
\node [annotation, above right, text ragged right, text width=5mm]  at (plotmap.120) {plotmap\\map.identify\\index.grid};
...
\node [annotation, below right, text ragged right]at (spcbl.250)
