...
list \url{hyperspec-help@lists.r-forge.r-project.org}, subscription and archives are available at \url{http://r-forge.r-project.org/mail/?group_id=366}.
}\\[1cm]
...
more than welcome to contribute such import code to \phy. Secion~\ref{sec:writing-Import}, (p.~\pageref{sec:writing-Import}) gives an example of how to wrap up the code.
