...
and normalization.]{\includegraphics[width=0.49\textwidth]{chondro-fig-norm}}\subfloat[\label{fig:bl:perc} The spectra after substracting the 5\textsuperscript{th}
