...
\subsection{Wavelength Indices}\mFun{\Rfunction{wl2i} \Rfunction{i2wl}}
...
\section{Accessing Parts of the \Rclass{hyperSpec} Object}\mFun{\Rfunction{[[]] \$. \$..}}
...
All three plus some more handy abbrevations are also accessible via \Rmethod{plot}: \mFun{\Rfunction{plot}}
...
\subsection{Plotting False-Color Maps}\mFun{\Rfunction{plotmap}}
